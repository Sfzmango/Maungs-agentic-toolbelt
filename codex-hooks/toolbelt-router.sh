#!/usr/bin/env bash
#
# Generated by tools/build.py from hooks/toolbelt-router.sh — DO NOT EDIT BY HAND.
# Edit the canonical hooks/toolbelt-router.sh, then: python3 tools/build.py --target codex
#
