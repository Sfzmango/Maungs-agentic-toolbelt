...
<!-- Generated by tools/build.py from skills/bug-catcher/SKILL.md — DO NOT EDIT BY HAND. -->
...
- It does **not** touch load-bearing content — anything CI asserts (e.g. component-count strings), `AGENTS.md` (and `CLAUDE.md` when present), or a link **target** / numeric value / prose meaning.
