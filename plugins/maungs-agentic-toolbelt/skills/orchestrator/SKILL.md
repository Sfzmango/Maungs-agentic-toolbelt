...
<!-- Generated by tools/build.py from skills/orchestrator/SKILL.md — DO NOT EDIT BY HAND. -->
...
- The orchestrator ALSO infers greenfield automatically from the empty-tree heuristic (no manifest + no `AGENTS.md` (and `CLAUDE.md` when present) + <~5 tracked source files) — the flag is the explicit override for the cases the heuristic is intentionally conservative about.
