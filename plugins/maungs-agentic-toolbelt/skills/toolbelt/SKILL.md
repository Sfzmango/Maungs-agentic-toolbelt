...
<!-- Generated by tools/build.py from skills/toolbelt/SKILL.md — DO NOT EDIT BY HAND. -->
...
5. **Target-project context** — is there `AGENTS.md` (and `CLAUDE.md` when present) (case-insensitive) in the current working directory's repo? Its absence is the single highest-leverage thing to flag (recommend `$agentic-onboard`).
