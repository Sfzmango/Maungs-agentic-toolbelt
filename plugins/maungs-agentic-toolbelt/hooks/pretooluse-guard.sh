#!/usr/bin/env bash
#
# Generated by tools/build.py from hooks/pretooluse-guard.sh — DO NOT EDIT BY HAND.
# Edit the canonical hooks/pretooluse-guard.sh, then: python3 tools/build.py --target codex
#
