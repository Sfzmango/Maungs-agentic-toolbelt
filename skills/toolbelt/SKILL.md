...
6. **Surface gaps**: if `CLAUDE.md` is absent in the current repo, add ONE line recommending `/agentic-onboard` first. If you fell back to the documented set, say so.
